...
// Surveyed boundary — Henry Land Surveying, 14 Nov 2024, Parcel 2 of 14-PM-15.
// One segment per recorded call, clockwise from the NE corner. Geometry from data/sulphur-survey.json;
// edit that file (or refit the traverse) rather than these numbers. Closure 0.007 ft, 9.465 ac.
const SULPHUR_BOUNDARY = [
  {
    id: 'boundary_north_line',
    coordinates: [[34.4335522, -119.1548396], [34.4335632, -119.1569291]],
    thickness: 10,
    gradientColors: ['#9C27B0', '#673AB7', '#3F51B5', '#2196F3'],
    glowColor: '#9C27B0',
    description: "Runs due west along the record line from the north-east corner to the north-west corner. Record call N90°00'00\"W, 630.04 ft.",
    name: "North Line",
    length: '630.04 ft',
    bearing: "N90°00'00\"W",
    features: ["Found iron pipe at the NE corner, 0.75 ft off", "Found iron pipe at the NW corner, 3.72 ft off", "Flat ground, 1,376–1,380 ft"],
    permanent: true,
    section: 'north'
  },
  {
    id: 'boundary_west_line_upper',
    coordinates: [[34.4335632, -119.1569291], [34.4325257, -119.1569371]],
    thickness: 10,
    gradientColors: ['#2196F3', '#03A9F4', '#00BCD4'],
    glowColor: '#2196F3',
    description: "From the north-west corner south to where the panhandle opens. Record call N00°00'00\"E, 377.58 ft.",
    name: "West Line (upper)",
    length: '377.58 ft',
    bearing: "N00°00'00\"E",
    features: ["16 ft access easement along this line", "Found lead & tack in a concrete footing, 69 ft south of the corner", "Dirt road inside the easement"],
    permanent: true,
    section: 'west'
  },
  {
    id: 'boundary_panhandle_north',
    coordinates: [[34.4325257, -119.1569371], [34.4323837, -119.1578497]],
    thickness: 10,
    gradientColors: ['#00BCD4', '#26C6DA', '#4DD0E1'],
    glowColor: '#00BCD4',
    description: "The upper edge of the wedge running west-south-west. Record call N79°00'00\"E, 280.00 ft.",
    name: "Panhandle, north side",
    length: '280.00 ft',
    bearing: "N79°00'00\"E",
    features: ["16 ft access easement along this line", "Dirt road", "Lowest ground on the parcel, ~1,370 ft"],
    permanent: true,
    section: 'panhandle'
  },
  {
    id: 'boundary_panhandle_tip',
    coordinates: [[34.4323837, -119.1578497], [34.4322793, -119.1578505]],
    thickness: 10,
    gradientColors: ['#4DD0E1', '#26A69A'],
    glowColor: '#26A69A',
    description: "The short western end of the wedge. Record call N00°00'00\"E, 38.00 ft.",
    name: "Panhandle tip",
    length: '38.00 ft',
    bearing: "N00°00'00\"E",
    features: ["Found iron pipe", "Furthest point from the road"],
    permanent: true,
    section: 'panhandle-tip'
  },
  {
    id: 'boundary_panhandle_south',
    coordinates: [[34.4322793, -119.1578505], [34.4321410, -119.1569400]],
    thickness: 10,
    gradientColors: ['#26A69A', '#4CAF50', '#66BB6A'],
    glowColor: '#4CAF50',
    description: "The lower edge of the wedge, back east to the west line. Record call N79°58'41\"W, 279.12 ft.",
    name: "Panhandle, south side",
    length: '279.12 ft',
    bearing: "N79°58'41\"W",
    features: ["Foot of the hillside", "Contours begin to tighten here"],
    permanent: true,
    section: 'panhandle'
  },
  {
    id: 'boundary_west_line_lower',
    coordinates: [[34.4321410, -119.1569400], [34.4317976, -119.1569426]],
    thickness: 10,
    gradientColors: ['#66BB6A', '#8BC34A', '#CDDC39'],
    glowColor: '#8BC34A',
    description: "From the panhandle south to the south-west corner. Record call N00°00'00\"E, 125.00 ft.",
    name: "West Line (lower)",
    length: '125.00 ft',
    bearing: "N00°00'00\"E",
    features: ["Steep ground begins", "Oak woodland"],
    permanent: true,
    section: 'west'
  },
  {
    id: 'boundary_south_line',
    coordinates: [[34.4317976, -119.1569426], [34.4317873, -119.1549996]],
    thickness: 10,
    gradientColors: ['#CDDC39', '#FFEB3B', '#FDD835', '#FBC02D'],
    glowColor: '#FDD835',
    description: "Runs due east along the toe of the hillside to the south-east corner. Record call N90°00'00\"E, 585.92 ft.",
    name: "South Line",
    length: '585.92 ft',
    bearing: "N90°00'00\"E",
    features: ["Steep hillside rising to 1,480 ft", "1 ft contours packed tight on the sheet", "Mapped landslide terrain touches the parcel here"],
    permanent: true,
    section: 'south'
  },
  {
    id: 'boundary_east_line_lower',
    coordinates: [[34.4317873, -119.1549996], [34.4326631, -119.1549928]],
    thickness: 10,
    gradientColors: ['#FBC02D', '#FFC107', '#FFB300'],
    glowColor: '#FFC107',
    description: "The road frontage, from the south-east corner north to the notch. Record call N00°00'00\"E, 318.72 ft.",
    name: "East Line (lower)",
    length: '318.72 ft',
    bearing: "N00°00'00\"E",
    features: ["Sulphur Mountain Rd frontage", "County and survey agree to under a foot along this side", "Corral / paddock grid inside the line"],
    permanent: true,
    section: 'east'
  },
  {
    id: 'boundary_notch_riser',
    coordinates: [[34.4326631, -119.1549928], [34.4328552, -119.1549783]],
    thickness: 10,
    gradientColors: ['#FFB300', '#FFA000'],
    glowColor: '#FFA000',
    description: "The short leg that steps the frontage 44 ft outward. Record call N03°13'00\"E, 70.06 ft.",
    name: "Notch (riser)",
    length: '70.06 ft',
    bearing: "N03°13'00\"E",
    features: ["Bearing N03°13'00\"E — the only call off the cardinal grid"],
    permanent: true,
    section: 'east-notch'
  },
  {
    id: 'boundary_notch_jog',
    coordinates: [[34.4328552, -119.1549783], [34.4328545, -119.1548450]],
    thickness: 10,
    gradientColors: ['#FFA000', '#FF8F00'],
    glowColor: '#FF8F00',
    description: "The step east across the top of the notch. Record call N90°00'00\"E, 40.19 ft.",
    name: "Notch (jog)",
    length: '40.19 ft',
    bearing: "N90°00'00\"E",
    features: ["Shed just inside the line"],
    permanent: true,
    section: 'east-notch'
  },
  {
    id: 'boundary_east_line_upper',
    coordinates: [[34.4328545, -119.1548450], [34.4335522, -119.1548396]],
    thickness: 10,
    gradientColors: ['#FF8F00', '#FF6F00', '#E65100', '#9C27B0'],
    glowColor: '#E65100',
    description: "From the notch north to the north-east corner. Record call N00°00'00\"E, 253.91 ft.",
    name: "East Line (upper)",
    length: '253.91 ft',
    bearing: "N00°00'00\"E",
    features: ["Sulphur Mountain Rd frontage", "Power pole at the corner", "House sits 250 ft inside this line"],
    permanent: true,
    section: 'east'
  }
];
