...
const PROJECT_ZONES = [
  ...
  },
  {
    ...
    revenueStreams: [
      ...
      "  • Dairy products (cheese, yogurt, milk): $2,500/month",
      "  • Grass-fed meat sales: $2,000/month",
      "  • Egg production and sales: $1,000-$1,500/month",
      "  • Fiber and textiles: $1,000/month",
      "SERVICES & EXPERIENCES:",
      "  • Horse therapies and animal-assisted wellness: $1,000-$2,000/month",
      "  • Educational farm tours and workshops: $500-$1,000/month",
      "  • Goat rentals for land clearing and grazing: $500-$1,000/month",
      "MULTI-CHANNEL SALES:",
      "  • Farmers market sales: $1,000-$1,500/month",
      "  • Online shop and direct shipping: $1,000-$1,500/month",
      "  • Farmstead membership and visitor exchange: $500-$1,000/month",
...
\` : '')}
        ...
        ${zone.id === 'tropical-dome-greenhouse' ? `
          <div class="project-section">
