...
const PROJECT_ZONES = [
  ...
  },
  {
    ...
    name: "Mushroom Cultivation & Production",
    emoji: "🍄",
    position: [34.433474, -119.156218],
    polygon: [[34.4335, -119.1565], [34.4340, -119.1565], [34.4340, -119.1555], [34.4335, -119.1555]],
    type: "agriculture",
    budget: "$17,000-$28,000", 
    timeline: "Phase 1-4 (0-7+ months)",
    monthlyRevenue: "$2,000-$8,000",
    roi: "80-213% annual ROI",
    description: "Multi-purpose organic mushroom cultivation facility serving commercial production and community wellness. Trailer-based modular operation producing culinary and medicinal varieties for local restaurants, health stores, and farm-to-table distribution. Generates healing mushroom products including tinctures, supplements, and educational workshops.",
    
    developmentTimeline: [
      {
        phase: "Phase 1 (Months 0-3): Site Prep",
        deliverables: "Clear and grade site, prepare utility hookups",
        investment: "$1,000-$2,000",
        status: "Foundation preparation"
      },
      {
        phase: "Phase 2 (Months 2-4): Setup & Partnerships",
        deliverables: "Deliver trailers, install systems, establish restaurant/market partnerships",
        investment: "$16,000-$26,000",
        status: "Infrastructure build-out"
      },
      {
        phase: "Phase 3 (Months 4-7): Operations Launch",
        deliverables: "First cultivation cycles, trial harvests, begin local distribution",
        status: "Initial production"
      },
      {
        phase: "Phase 4 (Months 7+): Full Production",
        deliverables: "Consistent harvests, product line expansion, steady revenue generation",
        monthlyRevenue: "$2,000-$8,000",
    ...
    smartFeatures: [
      "Solar Self-Sustainability - Off-grid power for all operations",
      "Modular Design - Trailer-based, expansion-ready, scalable",
      "Local Partnerships - Direct supply to restaurants, health stores, farmers markets",
      "Product Diversity - Fresh mushrooms, tinctures, supplements, dried blends",
      "Educational Integration - Workshops, farm-to-table, community wellness programs"
    ],
    
    marketAnalysis: "Mushrooms support immune function, brain health, stress adaptation, and overall wellness. Products include fresh culinary varieties (oyster, shiitake, lion's mane), medicinal tinctures, supplements, and value-added products. Distribution through local restaurants, health stores, farmers markets, farm stand, and online sales. Positioned as Ojai's first dedicated organic mushroom facility bridging farm-to-table dining with functional medicine.",
    
    features: [
      "Climate-controlled growing chambers",
      "Substrate preparation area", 
      "Multiple mushroom varieties (shiitake, oyster, lion's mane, reishi, turkey tail)",
      "Medicinal tincture production",
    ...
    revenueStreams: [
      "Fresh culinary mushrooms: $1,000-$3,000/month",
      "Medicinal products (tinctures, supplements): $500-$3,000/month", 
      "Workshops & educational programs: $500-$2,000/month",
      "Break-even: 7-15 months",
      "3-Year Net Revenue: $80,000-$160,000"
    ]
  },
  {
